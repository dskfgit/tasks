...
public class TasksServlet extends HttpServlet {
	...
	protected void service(final HttpServletRequest req, final HttpServletResponse resp)
		...
		try {
			...
			TasksDataProvider dataProvider = (TasksDataProvider) session
					.getAttribute(TasksDataProvider.class.getName());
			// Always reload.
			...
			ServiceMetadata edm = odata.createServiceMetadata(new TasksEdmProvider(), new ArrayList<EdmxReference>());
